...
* erosion: For every foreground pixel, put the mask around it, and if any pixel covered by the mask is from the background, set all these pixels to background.

* dilation: For every background pixel, put the mask around it, and if any pixel covered by the mask is from the foreground, set all these pixels to foreground.
