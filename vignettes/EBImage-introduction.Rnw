...
\author{Andrzej Oles, Gregoire Pau, Oleg Sklyar, Wolfgang Huber\\\email{gpau@ebi.ac.uk}}
...
or URLs. Currently supported image formats are JPEG, PNG and TIFF\footnote{See the RBioFormats package for support of a much wider range of formats.}.
