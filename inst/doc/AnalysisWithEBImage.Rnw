...
%% - why is compression a slot of the Image class? It does not  
%%   belong there. It should be an argument of the writeImage function.
...
\caption{\label{figure:histsbefore}Histogrammes of intensities of 
the four images in \file{Gene1\_{}R.tif}.}
\end{center}
\end{figure}
%
