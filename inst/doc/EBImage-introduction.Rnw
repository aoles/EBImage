...
\renewcommand{\thetitle}{Introduction to \Rpackage{EBImage}} % short title used in headers
...
or URLs. Current supported image formats are JPEG, PNG and TIFF.
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.48\textwidth]{lena.jpeg}
\includegraphics[width=0.48\textwidth]{lenac.jpeg}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.48\textwidth]{lenak.jpeg}
\includegraphics[width=0.48\textwidth]{lenab.jpeg}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.48\textwidth]{lenaflo.jpeg}
\includegraphics[width=0.48\textwidth]{lenafhi.jpeg}
