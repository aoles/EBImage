...
\usage{
    objectCount(x, minArea = 20, maxRadius = 100, tolerance = 1, maxObjects = 1000, modify = FALSE)
}
\arguments{
    ...
    \item{modify}{Whether the original image should be modify to show the object false-color map or kep intact.}
}
